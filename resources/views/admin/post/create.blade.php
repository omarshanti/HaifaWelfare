...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Posts</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Create Post</span>
            </div>
        </div>
                    ...
                    <div id="wizard1">
                        ...
                        <section>
                            <div class="control-group form-group">
                                ...
                                <input type="text" class="form-control required" name="name_en" placeholder="Name">
                            ...
                            <div class="form-group mb-0 justify-content-end">
                                <div class="checkbox">
                                    <div class="custom-checkbox custom-control">
                                        <input type="checkbox" data-checkboxes="mygroup" class="custom-control-input" name="is_main" id="checkbox-2">
                            ...
                            <div class="control-group form-group">
                                ...
                                <div class="ql-wrapper ql-wrapper-demo bg-gray-50">
                                    <input id="x" type="hidden" name="content_en">
                        ...
                        <section>
                            <div class="control-group form-group">
                                ...
                                <input type="text" class="form-control required" name="name_ar" placeholder="Name">
                                @if($errors->has('content_en'))
                            ...
                            <div class="control-group form-group">
                                ...
                                <div class="ql-wrapper ql-wrapper-demo bg-gray-50">
                                    <input id="y" type="hidden" name="content_ar">
                        ...
                        <section>
                            ...
                            <div class="row">
                                ...
                                <div class="row row-xs wd-xl-80p">
                                    <div class="col-sm-6 col-md-3 mg-t-10 mg-md-t-0"><button type="submit" class="btn btn-success btn-with-icon btn-block"><i class="typcn typcn-edit"></i> Create</button></div>
                                </div>
                            </div>
                            <!-- row closed -->
                        </section>
