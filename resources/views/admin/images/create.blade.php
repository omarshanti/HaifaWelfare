...
@section('title')
    Haifa Association - Upload Gallery
@stop
@section('css')
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Gallery</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Upload Images</span>
            </div>
        </div>
        ...
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
            <div class="card  box-shadow-0 ">
                <div class="card-header">
                    <h4 class="card-title mb-1">Create Gallery Images</h4>
                </div>
