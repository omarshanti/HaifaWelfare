									...
									<div class="main-content-left main-content-left-contacts">
										...
										<div class="main-contacts-list" id="mainContactList">
											...
											<div class="main-contact-item">
												...
												<div class="main-contact-body">
                                                    <a href="{{route('singleMessage',['id' => $message->data['id'],'notify' => $message->id])}}"><h6 style="font-weight: normal">{{$message->data['name']}}</h6></a><span>{{$message->data['phone']}}</span>
												</div>
												<a class="main-contact-star" href="{{route('deleteMsg',['id' => $message->data['id'],'notify' => $message->id])}}">
                                                    <i class="fe fe-trash-2 mr-1"></i>
												</a>
                                ...
                                <div class="main-contact-info-body p-4">
                                    ...
                                    <div class="media-list pb-0">
                                        <div class="media">
                                            <div class="media-body">
                                                <div>
                                                    <label>Phone</label> <span class="tx-medium">{{$sm->phone}}</span>
                                                </div>
                                                <div>
                                                    <label>Email</label> <span class="tx-medium">{{$sm->email}}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
