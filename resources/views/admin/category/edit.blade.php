...
@section('title')
    Haifa Association - Edit Category
@stop
@section('css')
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Categories</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Edit Category</span>
            </div>
        </div>
                    ...
                    <form method="post" action="{{route('category.update',$cat->id)}}">
                        ...
                        <div class="">
                            <div class="form-group">
                                ...
                                <input type="text" name="name_en" class="form-control" value="{{$cat->name_en}}"  placeholder="Enter Name">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name_ar" class="form-control" value="{{$cat->name_ar}}"  placeholder="Enter Name">
