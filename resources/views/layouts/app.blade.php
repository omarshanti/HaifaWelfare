                                ...
                                <div class="owl-carousel-inline-wrap">
                                    <div class="owl-carousel owl-carousel-inline" data-items="1" data-dots="false"
                                        ...
                                        <article class="post-inline">
                                            ...
                                            <p class="post-inline-title">Haifa Association for the Palestinian Family
                                                Care</p>
                                        </article>
...
{{--                                    <li>--}}
{{--                                        <a class="select select-inline" rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">--}}
{{--                                            {{ $properties['native'] }}--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                @endforeach--}}
                                @if(Auth::check())
                                    <li><a class="link link-icon link-icon-left link-classic"
                                           href="{{route('dashboard')}}"><span class="icon fl-bigmug-line-menu40
"></span><span class="link-icon-text">Dashboard</span></a></li>
                                    <li><a class="link link-icon link-icon-left link-classic"
                                           href="{{route('logout')}}"><span class="icon fl-bigmug-line-user144
"></span><span class="link-icon-text">Logout</span></a></li>
                                @endif
                                @if(!Auth::check())
                                    <li><a class="link link-icon link-icon-left link-classic" href="{{route('login')}}"><span
                                                class="icon fl-bigmug-line-user144
"></span><span class="link-icon-text">Login</span></a></li>
                                @endif
                ...
                <div class="rd-navbar-main">
                    <div class="rd-navbar-main-top">
                        <div class="rd-navbar-main-container container">
                            <!-- RD Navbar Brand-->
                            <div class="rd-navbar-brand"><a href="{{route('home')}}"><img class="brand-logo "
                                                                           src="{{asset('images/haifa-logo.png')}}"
                                                                           alt="" width="95" height="126"/></a>
                            </div>
                            <!-- RD Navbar List-->
                            <ul class="rd-navbar-list" style="visibility: hidden">
                                <li class="rd-navbar-list-item"><a class="rd-navbar-list-link" href="#"><img
                                            src="{{asset('images/partners-1-inverse-75x42.png')}}" alt="" width="75"
                                            height="42"/></a></li>
                                <li class="rd-navbar-list-item"><a class="rd-navbar-list-link" href="#"><img
                                            src="{{asset('images/partners-2-inverse-88x45.png')}}" alt="" width="88"
                                            height="45"/></a></li>
                                <li class="rd-navbar-list-item"><a class="rd-navbar-list-link" href="#"><img
                                            src="{{asset('images/partners-3-inverse-79x52.png')}}" alt="" width="79"
                                            height="52"/></a></li>
                            </ul>
                            <!-- RD Navbar Search-->
                            <div class="rd-navbar-search">
                                <button class="rd-navbar-search-toggle" data-rd-navbar-toggle=".rd-navbar-search">
                                    <span></span></button>
                                <form class="rd-search" action="{{route('search')}}" data-search-live="rd-search-results-live"
                                      method="GET">
                                    <div class="form-wrap">
                                        <label class="form-label" for="rd-navbar-search-form-input">Enter your search
                                            request here...</label>
                        ...
                        <div class="rd-navbar-main-container container">
                            ...
                            <ul class="rd-navbar-nav">
                                    ...
                                    <ul class="rd-menu rd-navbar-dropdown">
                                        @foreach($cat as $cats)
                                            <li class="rd-dropdown-item"><a class="rd-dropdown-link"
                                                                            href="{{route('categoryPost',$cats->id)}}">{{$cats->name_en}}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </li>
                                <li class="rd-nav-item rd-navbar--has-dropdown rd-navbar-submenu"><a class="rd-nav-link"
                                    ...
                                    <ul class="rd-menu rd-navbar-dropdown">
                                        ...
                                        <li class="rd-dropdown-item"><a class="rd-dropdown-link"
                                                                        href="{{route('ourAims')}}">Our Aims</a>
                                        </li>

                                    </ul>
                                </li>
                                <li class="rd-nav-item"><a class="rd-nav-link" href="{{route('contactUs')}}">Contact
                                        us</a>
                                </li>
                            </ul>
                            <div class="rd-navbar-main-element">
                                <ul class="list-inline list-inline-sm">
                                    ...
                                    <li><a class="icon icon-xs icon-light fa fa-youtube-play" href="#"></a></li>
                ...
                <div class="row row-50">
                    <div class="col-lg-5 text-center text-sm-left">
                        <article
                            ...
                            <div class="unit-left"><a href="./"><img class="brand-logo "
                                                                     src="{{asset('images/haifa-logo.png')}}"
                                                                     alt="" width="95" height="126"/></a>
                            </div>
                            <div class="unit-body">
                                <p>Gaza, Al-Nasr Street, next to Al-Helou Petrol Station
                                </p>
                            </div>
                        </article>
                        <ul class="list-inline list-inline-bordered list-inline-bordered-lg">
                            <li>
                                <div class="unit unit-horizontal unit-middle">
                                    ...
                                    <div class="unit-body">
                                        <h6>Phone</h6><a class="link" href="mailto:#">00972082873782</a>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="unit unit-horizontal unit-middle">
                                    ...
                                    <div class="unit-body">
                                        <h6>Contact Us</h6><a class="link" href="mailto:#">info@haifawelfare.ps</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
                        <div class="group-md group-middle">
                            <div class="group-item">
                                <ul class="list-inline list-inline-xs">
                                    ...
                                    <li><a class="icon icon-corporate fa fa-youtube-play" href="#"></a></li>
                                    <li><a class="icon icon-corporate fa fa-instagram" href="#"></a></li>
                                </ul>
                            </div>
                            <a class="button button-sm button-gray-outline" href="{{route('contactUs')}}">Get in Touch</a>
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <h5>Popular News</h5>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <article class="post-classic">
                                            <div class="post-classic-aside"><a class="post-classic-figure"
                                                                               href="{{route('singlePost',$post->id)}}"><img
                                                        src="{{asset('imagePosts/photo1/'.$post->photo2)}}" alt=""
                                                        width="93" height="87"/></a></div>
                                            <div class="post-classic-main">
                                                <!-- Badge-->
                                                <div @if($post->Category->id == 3) class="badge badge-primary"
                                                     @elseif($post->Category->id == 4) class="badge badge-red"
                                                     @else class="badge badge-secondary" @endif >NEW
                                                </div>
                                                <p class="post-classic-title"><a
                                                        href="{{route('singlePost',$post->id)}}">{{$post->name_en}}</a>
                                                </p>
        ...
        <div class="footer-classic-aside footer-classic-darken">
            <div class="container">
                <div class="layout-justify">
                    <!-- Rights-->
                    <p class="rights"><span>Haifa</span><span>&nbsp;&copy;&nbsp;</span><span
                            class="copyright-year"></span><span>.&nbsp;</span><span>Designed by <a
                                href="https://www.facebook.com/omar.shanti.9">OM@R.</a></span></p>
